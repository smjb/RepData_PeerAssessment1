...
_**Note:** This analysis uses_ **ggplot2**_,_ **lubridate**_,_ **dplyr** _and_ **xtable** _packages_
...
pow_wfa
wd_wfa <- pow_wfa[pow_wfa$period.of.week=="weekday", ]
we_wfa <- pow_wfa[pow_wfa$period.of.week=="weekend", ]
plot(wd_wfa$interval, wd_wfa$interval.mean.step, type="l", col="red", lwd=1)
lines(we_wfa$interval, we_wfa$interval.mean.step,  col="green", lwd=1)
